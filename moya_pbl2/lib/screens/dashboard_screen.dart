    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          child: CircleAvatar(
            backgroundColor: const Color(0xFFD3D3D3), // Abu-abu muda untuk avatar default
              ...
              return Column(
                children: [
                  Container(
                    ...
                    height: 35,
                    decoration: BoxDecoration(
                      color: hasMood ? const Color(0xFFF3C4D3) : Colors.white,
                      shape: BoxShape.circle,
                    ),
                    child: hasMood
                        ? Center(
                      child: Image.asset(
                        'assets/images/mood_happy.png', // Ganti nanti
                        width: 20,
                        height: 20,
                      ),
                    )
        ...
        children: [
          ...
          if (_isThingsToDoExpanded)
            Container(
              padding: const EdgeInsets.all(16),
              decoration: const BoxDecoration(
                color: Color(0xFFE8F4E9), // Background list putih/hijau sangat muda
